...
internal sealed class ExpressionResolverBuilder : CallSiteVisitor<object?, Expression>
{
    ...
    private static readonly BinaryExpression ResolvedServicesVariableAssignment =
        Expression.Assign(ResolvedServices,
            Expression.Property(
                ScopeParameter,
                typeof(ServiceProviderEngineScope).GetProperty(nameof(ServiceProviderEngineScope.ResolvedServices),
    ...
    private static readonly BinaryExpression SyncVariableAssignment =
        Expression.Assign(Sync,
            Expression.Property(
                ScopeParameter,
                typeof(ServiceProviderEngineScope).GetProperty(nameof(ServiceProviderEngineScope.Sync),
                    BindingFlags.Instance | BindingFlags.NonPublic)!));
    ...
    public ExpressionResolverBuilder(TestudoServiceProvider serviceProvider)
    {
    ...
    public Func<ServiceProviderEngineScope, object> BuildNoCache(ServiceCallSite callSite)
    {
        ...
        DependencyInjectionEventSource.Log.ExpressionTreeGenerated(_rootScope.RootProvider, callSite.ServiceType,
            expression);
    ...
    private Expression<Func<ServiceProviderEngineScope, object>> BuildExpression(ServiceCallSite callSite)
    {
        ...
        return Expression.Lambda<Func<ServiceProviderEngineScope, object>>(
            Convert(VisitCallSite(callSite, null), typeof(object), true),
            ScopeParameter);
    }
    ...
    protected override Expression
        VisitServiceProvider(ServiceProviderCallSite serviceProviderCallSite, object? context) => ScopeParameter;
        ...
        return Expression.Condition(
            Expression.Property(
                ...
                typeof(ServiceProviderEngineScope)
                    .GetProperty(nameof(ServiceProviderEngineScope.IsRootScope),
    ...
    public static Expression GetCaptureDisposable(ParameterExpression scope)
    {
        ...
        {
            throw new NotSupportedException("Get capture disposable not supported.");
        }
